...
const DogAnalysis = () => {
  ...
  const shareOnWhatsApp = () => {
    ...
    const text = "Guarda l'analisi PetScan del cibo del mio cane!";
      ...
      <section className="pt-8 pb-12 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
            Analisi Completa del Cibo per <span style={{ color: '#1FC77C' }}>Cani</span>
          </h1>
          ...
          <div className="analysis-card bg-white rounded-3xl shadow-lg p-6 border border-gray-100 opacity-0 transition-all duration-500">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-center">
                ...
                <div className="w-32 h-32 mx-auto bg-gradient-to-br from-green-400 to-green-600 rounded-3xl flex items-center justify-center mb-4">
                  <img 
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Royal Canin Medium Adult</h3>
                <p className="text-gray-600 mb-4">Cane adulto taglia media, 15kg</p>
                <div className="inline-block bg-green-100 border border-green-300 px-4 py-2 rounded-full">
                  <span className="text-green-700 font-semibold">🐕 Specifico per cani</span>
                </div>
              </div>
              ...
              <div>
                <div className="text-center mb-6">
                  <div className="w-24 h-24 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl flex flex-col items-center justify-center text-white font-bold mx-auto mb-4">
                    <span className="text-3xl">92</span>
                    <span className="text-sm">/100</span>
                  </div>
                  <div className="bg-green-100 border border-green-300 px-4 py-2 rounded-full inline-block">
                    <span className="text-green-700 font-semibold">Ottimo</span>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-xl border border-green-200">
                    ...
                    <span className="text-green-600 font-semibold">Eccellente</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-xl border border-green-200">
                    <span className="font-semibold text-gray-900">✅ Conservanti</span>
                    <span className="text-green-600 font-semibold">Naturali</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-xl border border-green-200">
                    <span className="font-semibold text-gray-900">🌾 Cereali</span>
                    <span className="text-green-600 font-semibold">Bilanciati</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 p-6 bg-green-50 rounded-2xl border border-green-200">
              ...
              <ul className="space-y-2 text-gray-700">
                <li>✅ Eccellente contenuto proteico per cani attivi</li>
                <li>✅ Conservanti naturali (tocoferoli)</li>
                <li>✅ Formula bilanciata per cani di taglia media</li>
                <li>✅ Supporto per articolazioni e digestione</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="analysis-card bg-white rounded-3xl shadow-lg p-6 border border-gray-100 opacity-0 transition-all duration-500">
            ...
            <div className="text-center mb-8">
              <div className="w-20 h-20 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center text-white font-bold text-2xl mx-auto mb-4">
                🐕
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Bobby</h3>
              <p className="text-gray-600">Golden Retriever energico</p>
            </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">4 anni</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">🏃</span>
                    <div>
                      <div className="font-semibold text-gray-900">Attività</div>
                      <div className="text-gray-600">Molto attivo</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">🐕‍🦺</span>
                    <div>
                      <div className="font-semibold text-gray-900">Razza</div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">📏</span>
                    <div>
                      <div className="font-semibold text-gray-900">Taglia</div>
                      <div className="text-gray-600">Media-Grande</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">28 kg</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">⚕️</span>
                    <div>
                      <div className="font-semibold text-gray-900">Salute</div>
                      <div className="text-gray-600">Ottima forma</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6 flex flex-wrap gap-3 justify-center">
              <span className="bg-green-100 border border-green-300 text-green-700 px-4 py-2 rounded-full font-semibold">🏃 Attivo</span>
              <span className="bg-blue-100 border border-blue-300 text-blue-700 px-4 py-2 rounded-full font-semibold">♂ Maschio</span>
              <span className="bg-orange-100 border border-orange-300 text-orange-700 px-4 py-2 rounded-full font-semibold">🏠 Con giardino</span>
              <span className="bg-purple-100 border border-purple-300 text-purple-700 px-4 py-2 rounded-full font-semibold">🦴 Adulto</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="analysis-card bg-white rounded-3xl shadow-lg p-6 border border-gray-100 opacity-0 transition-all duration-500">
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 bg-green-50 rounded-2xl border border-green-200">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>✅ Ottima scelta per cani di taglia media-grande come Bobby</li>
                  <li>💡 Perfetto per il suo livello di attività elevato</li>
                  <li>✅ Supporta lo sviluppo muscolare e la salute articolare</li>
                  <li>🥤 Assicurati che abbia sempre acqua fresca disponibile</li>
                </ul>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 border border-gray-200 rounded-xl hover:shadow-lg transition-shadow">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900">Hill's Active Dog</div>
                        <div className="text-sm text-gray-600">Punteggio: 94/100</div>
                      </div>
                    </div>
                    <p className="text-sm text-gray-600">Formula premium per cani attivi</p>
                  </div>
                  ...
                  <div className="p-4 border border-gray-200 rounded-xl hover:shadow-lg transition-shadow">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900">Purina Pro Plan Sport</div>
                        <div className="text-sm text-gray-600">Punteggio: 91/100</div>
                      </div>
                    </div>
                    <p className="text-sm text-gray-600">Ideale per cani atletici e energici</p>
                  </div>
                </div>
              </div>
              ...
              <div id="contact" className="text-center p-6 bg-gradient-to-r from-green-50 to-orange-50 rounded-2xl border border-green-200">
                ...
                <p className="text-gray-600 mb-4">
                  I nostri esperti possono fornirti consigli specifici per Bobby
                </p>
                <button 
